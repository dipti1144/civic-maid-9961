  ...
  return (
    <>
        <Box display="flex" margin="auto"  w="80%" mt="5px" >
            <p style={{display:"flex", gap:"10px" , color:"gray"}}>GlamourWorld / GlamourWorls Collection / <p style={{color:"#ff3366"}} >{data.cat}</p></p>
        </Box>
        <Box display="flex" w="60%" margin="auto" mt="50px" justifyContent="space-between" >
            ...
            <Box w="35%" textAlign="left"  display="grid" gap="10px" h="150px" >
               ...
               <p style={{ size:"14px", color:"#ff3399"}}> {data.cat} : {data.title}  </p>
